...
Version 0.4.0 adds the dependency-free complete-suite verifier, closed JSON and
JUnit result contracts, and a token-free composite GitHub Action while
preserving the same five-file signing and verification boundary. Its five case
definitions and 72 expectation meanings remain compatible with v0.3.2.
